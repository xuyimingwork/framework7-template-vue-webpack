  ...
  <f7-page>
    ...
    <f7-list form>
      <f7-list-item>
        ...
        <f7-input type="text"
          placeholder="Name"></f7-input>
      </f7-list-item>
      <f7-list-item>
        <f7-label>E-mail</f7-label>
        <f7-input type="email"
          placeholder="E-mail"></f7-input>
      </f7-list-item>
      <f7-list-item>
        <f7-label>URL</f7-label>
        <f7-input type="url"
          placeholder="URL"></f7-input>
      </f7-list-item>
      <f7-list-item>
    ...
    <f7-block strong>
      ...
      <f7-row tag="p">
        <f7-button class="col"
          raised>Raised</f7-button>
        <f7-button class="col"
          raised
          fill>Raised Fill</f7-button>
      </f7-row>
      <f7-row tag="p">
        <f7-button class="col"
          round>Round</f7-button>
        <f7-button class="col"
          round
          fill>Round Fill</f7-button>
      </f7-row>
      <f7-row tag="p">
        <f7-button class="col"
          outline>Outline</f7-button>
        <f7-button class="col"
          round
          outline>Outline Round</f7-button>
      </f7-row>
      <f7-row tag="p">
        <f7-button class="col"
          small
          outline>Small</f7-button>
        <f7-button class="col"
          small
          round
          outline>Small Round</f7-button>
      </f7-row>
      <f7-row tag="p">
        <f7-button class="col"
          small
          fill>Small</f7-button>
        <f7-button class="col"
          small
          round
          fill>Small Round</f7-button>
      </f7-row>
      <f7-row tag="p">
        <f7-button class="col"
          big
          raised>Big</f7-button>
        <f7-button class="col"
          big
          fill
          raised>Big Fill</f7-button>
      </f7-row>
      <f7-row tag="p">
        <f7-button class="col"
          big
          fill
          raised
          color="red">Big Red</f7-button>
        <f7-button class="col"
          big
          fill
          raised
          color="green">Big Green</f7-button>
      </f7-row>
    </f7-block>
  </f7-page>
</template>
